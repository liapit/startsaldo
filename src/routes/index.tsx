...
function Index() {
  ...
  return (
    <main className="bg-background text-foreground">
      ...
      <section id="dienstleistungen" className="section-pad"><div className="section-shell"><p className="eyebrow">Unsere Dienstleistungen</p><h2 className="heading-lg mt-4">Was wir Ihnen abnehmen.</h2><p className="mt-5 text-[18px] leading-7 text-muted-foreground">Von der laufenden Finanzbuchhaltung bis zur monatlichen Lohnadministration – klar definiert und passend zu Ihrem Unternehmen.</p>
