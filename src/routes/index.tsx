...
function Index() {
  ...
  return (
    <main className="bg-background text-foreground">
      ...
      <section id="dienstleistungen" className="section-pad bg-card"><div className="section-shell"><div className="text-center"><p className="eyebrow">Unsere Dienstleistungen</p><h2 className="heading-lg mt-4">Was wir Ihnen abnehmen.</h2><p className="mx-auto mt-4 max-w-[350px] text-base leading-7 text-muted-foreground md:mt-5 md:max-w-none md:text-[18px]">Von der laufenden Finanzbuchhaltung bis zur monatlichen Lohnadministration.</p></div>
