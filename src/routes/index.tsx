...
function Index() {
  ...
  return (
    <main className="bg-background text-foreground">
      ...
      <section className="section-pad"><div className="section-shell"><div className="grid gap-8 md:grid-cols-2"><div><p className="eyebrow">Wenn Buchhaltung Zeit kostet</p><h2 className="heading-lg mt-4">Buchhaltung sollte nicht Ihr Tagesgeschäft bestimmen.</h2></div><p className="self-end text-[17px] leading-[1.7] text-muted-foreground">Belege, Löhne, Abstimmungen und administrative Fristen gehören zum Unternehmensalltag. Sie sollten aber nicht die Zeit beanspruchen, die Sie für Kunden, Mitarbeitende und Ihr Kerngeschäft benötigen.</p></div>
